...
const ContactSection = () => {
  ...
  return (
    <section id="kontakt" className="py-24 bg-white dark:bg-gray-800">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 h-full">
              ...
              <div className="mt-12">
                ...
                <div className="mt-4 flex space-x-6">
                  ...
                  <a
                    href="https://www.youtube.com/channel/UCcTaCUl2UN32ASInEZngIhg"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition"
                  >
                  ...
                  <a
                    href="https://open.spotify.com/artist/1PvGZp6n4B360g4hBVpGjz?utm_source=chatgpt.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition"
                  >
                  ...
                  <a
                    href="https://m.me/PAWELMOSIOLEK1976"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition text-xl"
                  >
                    <span className="sr-only">
                      {t("contact.socialMedia.messenger")}
                    </span>
                    <FaFacebookMessenger />
                  </a>
                </div>

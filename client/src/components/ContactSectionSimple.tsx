        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                    ...
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                      ...
                      <div className="space-y-1 leading-none">
                        <FormLabel className="text-sm text-gray-700 dark:text-gray-300">
                          Akceptuję <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">politykę prywatności</a>
                        </FormLabel>
                        <FormMessage />
                      </div>
                    </FormItem>
          ...
          <div className="mt-16 lg:mt-0">
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 h-full">
              <h3 className="text-xl font-medium text-gray-900 dark:text-white">Informacje kontaktowe</h3>
              <div className="mt-6 space-y-6">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">kontakt@pawelmosiolek.pl</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <p className="text-gray-900 dark:text-white">Manager</p>
                    <p className="text-gray-600 dark:text-gray-300">Anna Kowalska</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    <p className="text-gray-900 dark:text-white">Adres</p>
              ...
              <div className="mt-12">
                <h3 className="text-xl font-medium text-gray-900 dark:text-white">Media społecznościowe</h3>

        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                      ...
                      <div className="space-y-1 leading-none">
                        <FormLabel className="text-sm text-gray-700 dark:text-gray-300">
                          {t('contact.form.privacyPolicy')} <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">{t('contact.form.privacyPolicyLink')}</a>
                        </FormLabel>
                        <FormMessage />
                      </div>
                    </FormItem>
                ...
                <Button 
                  ...
                  className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition"
                >
          ...
          <div className="mt-16 lg:mt-0">
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 h-full">
              <h3 className="text-xl font-medium text-gray-900 dark:text-white">{t('contact.contactInfo.title')}</h3>
              <div className="mt-6 space-y-6">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <p className="text-gray-900 dark:text-white">{t('contact.contactInfo.emailLabel')}</p>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <p className="text-gray-900 dark:text-white">{t('contact.contactInfo.phoneLabel')}</p>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <p className="text-gray-900 dark:text-white">{t('contact.contactInfo.managerLabel')}</p>
                    <p className="text-gray-600 dark:text-gray-300">{t('contact.contactInfo.manager')}</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    <p className="text-gray-900 dark:text-white">{t('contact.contactInfo.addressLabel')}</p>
                    <div className="text-gray-600 dark:text-gray-300" 
                      dangerouslySetInnerHTML={{ __html: t('contact.contactInfo.address') }} />
              ...
              <div className="mt-12">
                ...
                <div className="mt-4 flex space-x-6">
                  <a href="https://www.facebook.com/PAWELMOSIOLEK1976" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition">

          ...
          <div className="lg:order-2 mb-12 lg:mb-0">
            <div className="text-center lg:text-left">
              ...
              <div className="mt-8 flex flex-wrap gap-4 justify-center lg:justify-start">
                ...
                <a href="https://www.facebook.com/PAWELMOSIOLEK1976" target="_blank" rel="noopener noreferrer" className="flex items-center text-blue-600 dark:text-blue-400 hover:underline">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">

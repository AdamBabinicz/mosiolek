                    ...
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                      ...
                      <div className="space-y-1 leading-none">
                        <FormLabel className="text-sm text-gray-700 dark:text-gray-300">
                          {t('contact.form.privacyPolicy')} <a href="#" className="text-primary dark:text-blue-400 hover:underline">{t('contact.form.privacyPolicyLink')}</a>
                        </FormLabel>
                        <FormMessage />
                      </div>
                    </FormItem>
              ...
              <div className="mt-6 space-y-6">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <div className="text-gray-600 dark:text-gray-300" dangerouslySetInnerHTML={{ __html: t('contact.contactInfo.address') }}></div>
                  </div>
                </div>
              </div>
